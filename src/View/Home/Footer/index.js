	...
	return (
		<div className="px-6 pt-8 pb-4 bg-primary-main mt-2 md:px-8 md:py-12 lg:px-12 xl:px-24">
			<div className="md:flex md:w-full md:h-full justify-between items-start lg:items-center">
				...
				<div className="grid grid-cols-2 gap-y-2 md:gap-x-6 mt-8 md:mt-0 md:grid-cols-3 lg:grid-cols-6 lg:text-center">
					<p className="text-white text-lg">Home Page</p>
					...
					<p className="text-white text-lg">Book audit</p>
